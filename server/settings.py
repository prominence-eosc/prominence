...
CONFIG['S3_SECRET_ACCESS_KEY'] = getattr(settings, 'PROMINENCE_S3_SECRET_ACCESS_KEY', None)
...
CONFIG['REQUIRED_ENTITLEMENTS'] = getattr(settings, 'PROMINENCE_REQUIRED_ENTITLEMENTS', '[]')
...
CONFIG['CLIENT_ID'] = getattr(settings, 'PROMINENCE_CLIENT_ID', '')
CONFIG['CLIENT_SECRET'] = getattr(settings, 'PROMINENCE_CLIENT_SECRET', '')
CONFIG['SCOPES'] = getattr(settings, 'PROMINENCE_SCOPES', '')
CONFIG['AUTHORISATION_BASE_URL'] = getattr(settings, 'PROMINENCE_AUTHORISATION_BASE_URL', '')
CONFIG['TOKEN_URL'] = getattr(settings, 'PROMINENCE_TOKEN_URL', '')
