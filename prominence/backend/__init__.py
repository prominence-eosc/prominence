...
class ProminenceBackend(object):
    ...
    from .execute_command import execute_command, _execute_command
    from .snapshots import create_snapshot, get_snapshot_url, validate_snapshot_path, _create_and_upload
