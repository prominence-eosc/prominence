...
class Job(models.Model):
    ...
    request_cpus = models.PositiveSmallIntegerField(default=1)
    request_memory = models.PositiveSmallIntegerField(default=1)
    request_disk = models.PositiveSmallIntegerField(default=10)
    request_nodes = models.PositiveSmallIntegerField(default=1)
