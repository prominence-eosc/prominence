...
urlpatterns = [
    ...
    path('jobs/actions/', views.job_actions, name='job_actions'),
    path('jobs/create/', views.job_create, name='job_create'),
    path('jobs/<int:pk>/delete/', views.jobs_delete, name='job_delete'),
    path('jobs/delete/', views.jobs_delete, name='jobs_delete'),
    ...
    path('workflows/actions/', views.workflow_actions, name='workflow_actions'),
    path('workflows/<int:pk>/delete/', views.workflows_delete, name='workflow_delete'),
    path('workflows/delete/', views.workflows_delete, name='workflows_delete'),
