...
urlpatterns = [
    ...
    path('v1/workflows/<int:workflow_id>/<string:job>/stdout', views.WorkflowStdOutView.as_view(), name='workflow_get_stdout'),
    path('v1/workflows/<int:workflow_id>/<string:job>/stderr', views.WorkflowStdErrView.as_view(), name='workflow_get_stderr'),
]
